...
import rospy
import actionlib
from my_turtlebot_topics.msg import record_odomAction , record_odomFeedback, record_odomResult
from nav_msgs.msg import Odometry
from odo_subscriber import odo_sub
...
class RecordOdomClass(object):
    ...
    def __init__(self, goal_distance):
        ...
        self._odom_reader_object = odo_sub()
        ...
        for i in range(self._seconds_recording):
            ...
            if self._as.is_preempt_requested():
                ...
                if not self.reached_distance_goal():
                    ...
                    self._result.result_odom_array.append(self._odom_reader_object.odo_get_data())
                else:
...
if __name__ == '__main__':
  ...
  RecordOdomClass(goal_distance=8.77)
  rospy.spin()
